...
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_Header       = _T("HEADER");
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_Version      = _T("VERSION");
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_VersionStamp = _T("VERSION_STAMP");
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_Name         = _T("NAME");
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_Value        = _T("VALUE");
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_ID           = _T("ID");
LPCTSTR controls::CBCGPBaseInfoEx::s_szTag_ElementName  = _T("ELEMENT_NAME");

controls::CBCGPBaseInfoEx::CBCGPBaseInfoEx(DWORD dwVersion, DWORD dwFlags)
...
controls::CBCGPBaseInfoEx::~CBCGPBaseInfoEx()
{
}

controls::CBCGPBaseInfoEx::XBase* controls::CBCGPBaseInfoEx::CreateBaseFromTag (const CString& tag, XCreateBaseFromNameProc lpCreateProc)
{
	...
	controls::CBCGPBaseInfoEx::XBase* base = NULL;

	CString strElementName;
	{
		CBCGPTagManager tm (tag);
		tm.ReadString (controls::CBCGPBaseInfoEx::s_szTag_ElementName, strElementName);
	}
...
controls::CBCGPBaseInfoEx::XID::XID ()
	: m_Value (0)
{
}
...
BOOL controls::CBCGPBaseInfoEx::XID::FromTag (const CString& strTag)
{
...
void controls::CBCGPBaseInfoEx::XID::ToTag (CString& strTag) const
{
...
controls::CBCGPBaseInfoEx::XImage::XImage () : m_bDontScale(FALSE)
{
}
controls::CBCGPBaseInfoEx::XImage::~XImage ()
{
}

BOOL controls::CBCGPBaseInfoEx::XImage::FromTag (const CString& strTag)
{
...
void controls::CBCGPBaseInfoEx::XImage::ToTag (CString& strTag) const
{
	if (m_Image.IsValid ())
	{
		m_ID.ToTag (strTag);
...
controls::CBCGPBaseInfoEx::XBase::XBase(const CString& strElementName)
	: m_strElementName (strElementName)
{
}

controls::CBCGPBaseInfoEx::XBase::~XBase()
{
}

void controls::CBCGPBaseInfoEx::XBase::ToTag (CString& strTag) const
{
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteString (s_szTag_ElementName, m_strElementName));
}

controls::CBCGPBaseInfoLoaderEx::CBCGPBaseInfoLoaderEx(CBCGPBaseInfo& info, LPCTSTR lpszResType, DWORD dwFlags)
	: m_Info       (info)
...
controls::CBCGPBaseInfoLoaderEx::~CBCGPBaseInfoLoaderEx()
{
}

BOOL controls::CBCGPBaseInfoLoaderEx::Load (UINT uiResID, LPCTSTR lpszResType, HINSTANCE hInstance/* = NULL*/)
{
	return Load (MAKEINTRESOURCE (uiResID), lpszResType, hInstance);
}

BOOL controls::CBCGPBaseInfoLoaderEx::Load (LPCTSTR lpszResID, LPCTSTR lpszResType, HINSTANCE hInstance/* = NULL*/, const CString& strWorkFlow)
{
	if (lpszResID == NULL)
	{
		ASSERT (FALSE);
...
BOOL controls::CBCGPBaseInfoLoaderEx::LoadFromFile (LPCTSTR lpszFileName)
{
...
BOOL controls::CBCGPBaseInfoLoaderEx::LoadFromBuffer (LPCTSTR lpszBuffer)
{
	if (lpszBuffer == NULL)
	{
		ASSERT(FALSE);
...
BOOL controls::CBCGPBaseInfoWriterEx::FileExists (const CString& fileName)
{
	return _taccess (fileName, 0) != -1;
}

BOOL controls::CBCGPBaseInfoWriterEx::IsFileReadOnly (const CString& fileName)
{
...
CString controls::CBCGPBaseInfoWriterEx::CorrectDirectoryName(const CString& dirName)
{
    CString dir(dirName);
...
BOOL controls::CBCGPBaseInfoWriterEx::CreateDirectory (const CString& dirName)
{
...
CString controls::CBCGPBaseInfoWriterEx::PrepareFileName (const CString& fileName)
{
...
CString controls::CBCGPBaseInfoWriterEx::CorrectFileName(const CString& dirName, const CString& fileName)
{
	CString str;
	// TODO:
	//AfxFullPath (str.GetBuffer (_MAX_PATH), CCustomizedBaseInfoWriter::CorrectDirectoryName (dirName) + fileName);
	//str.ReleaseBuffer ();

	return str;
}

void controls::CBCGPBaseInfoWriterEx::ParseFileName(const CString& pathName, CString& fileName, CString& extName)
{
	fileName.Empty ();
	extName.Empty ();
...
void controls::CBCGPBaseInfoWriterEx::ParseFilePath(const CString& pathName, CString& dirName, CString& fileName)
{
	dirName.Empty ();
	fileName.Empty ();
...
public:
	...
	{
		if (controls::CBCGPBaseInfoWriterEx::IsFileReadOnly (filename))
		{
...
controls::CBCGPBaseInfoWriterEx::CBCGPBaseInfoWriterEx(controls::CBCGPBaseInfoEx& info)
	: m_Info(info)
{
}

controls::CBCGPBaseInfoWriterEx::~CBCGPBaseInfoWriterEx()
{
}

BOOL controls::CBCGPBaseInfoWriterEx::CheckFiles(const CStringArray& sa) const
{
	BOOL bRes = TRUE;

	for (int i = 0; i < sa.GetSize (); i++)
	{
		if (!CBCGPBaseInfoWriterEx::FileExists (sa[i]))
		{
			continue;
		}

		if (CBCGPBaseInfoWriterEx::IsFileReadOnly (sa[i]))
		{
...
void CBCGPBaseInfoWriterEx::ErrorReportFolder (const CString& /*strName*/) const
{
}

void CBCGPBaseInfoWriterEx::ErrorReportFileRO (const CString& /*strName*/) const
{
}

BOOL CBCGPBaseInfoWriterEx::WriteText (const CString& strFileName, const CStringArray& text) const
{
	CFileWriterText writer (text);
	return writer.CFileWriter::Write (strFileName);
}

BOOL CBCGPBaseInfoWriterEx::WriteBinary (const CString& strFileName, LPCVOID lpBuffer, int count) const
{
	CFileWriterBinary writer ((LPCVOID)lpBuffer, count);
	return writer.CFileWriter::Write (strFileName);
}

BOOL CBCGPBaseInfoWriterEx::SaveInfo (const CString& strFileName)
{
