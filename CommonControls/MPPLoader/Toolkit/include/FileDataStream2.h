...
//! 定义文档读数据流
class COMMONCONTROLS_API CFileDataReadStream : public IRandomReadStream
{
public:
...
//! 定义文档写数据流
class COMMONCONTROLS_API CFileDataWriteStream : public IRandomWriteStream
{
public:
