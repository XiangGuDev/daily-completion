 ...
 */
class MPP14Reader : public MPPVariantReader
{
public:
	MPP14Reader();
...
private:
	 ...
	 */
	void processResource2EnterpriseColumns(int id, Resource2* resource, Var2DataPtr resourceVarData, ByteArrayPtr metaData2);
...
protected:
	...
	Map2<__int64, int> m_taskOrder;//key ,val = UId
	Map2<int, int> m_nullTaskOrder;//ID  ,UId
	...
	static const int SUBPROJECT_TASKUNIQUEID4 = 0x0BD50000;
	static const int SUBPROJECT_TASKUNIQUEID5 = 0x03D60000;
	static const int SUBPROJECT_TASKUNIQUEID6 = 0x067F0000;
	static const int SUBPROJECT_TASKUNIQUEID7 = 0x067D0000;

	/**
	 * Calendar data types.
	 */
	static const int CALENDAR_NAME = 1;
	static const int CALENDAR_DATA = 8;

	/**
	 * Resource2 data types.
	 */
	static const int TABLE_COLUMN_DATA_STANDARD = 6;
	static const int TABLE_COLUMN_DATA_ENTERPRISE = 7;
	static const int TABLE_COLUMN_DATA_BASELINE = 8;
	static const int OUTLINECODE_DATA = 22;
	...
	static const long RESOURCE_FIELD_NAME_ALIASES = 71303169;
	static const long TASK_FIELD_NAME_ALIASES = 71303169;
	...
	static const int NULL_TASK_BLOCK_SIZE = 16;
	...
	static MppBitFlagArrayPtr PROJECT2010_TASK_META_DATA_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2013_TASK_META_DATA_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2010_TASK_META_DATA2_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2013_TASK_META_DATA2_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2010_RESOURCE_META_DATA2_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2013_RESOURCE_META_DATA2_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2010_RESOURCE_META_DATA_BIT_FLAGS;

	static MppBitFlagArrayPtr PROJECT2013_RESOURCE_META_DATA_BIT_FLAGS;
};

class MPP12Reader : public MPP14Reader
{
public:
	// 获取不同版本参数
	virtual const MPPVersionParams* getVersionParams();
