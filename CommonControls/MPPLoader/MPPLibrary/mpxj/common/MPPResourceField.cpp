...
*/
Resource2Field MPPResource2Field::getInstance(int value)
{
	init();
...
* @return field ID
*/
int MPPResource2Field::getID(Resource2Field value)
{
	init();
    return (ID_ARRAY[value]);
}

void MPPResource2Field::init()
{
    ...
    FIELD_ARRAY[808] = Resource2Field::RF_UNAVAILABLE;
    ...
    FIELD_ARRAY[152] = Resource2Field::RF_SUBPROJECT_RESOURCE_UNIQUE_ID;
    ...
    FIELD_ARRAY[341] = Resource2Field::RF_ENTERPRISE_DATA;
...
Resource2Field MPPResource2Field::FIELD_ARRAY[MAX_VALUE] = { Resource2Field(-1) };
int MPPResource2Field::ID_ARRAY[Resource2Field::RF_FINISH+1] = { -1 };
