...
DECLARE_ENUMTYPENAME_CONVERSION(EFormatType);
DECLARE_ENUMTYPENAME_CONVERSION(ETreeListEditFlag);
DECLARE_ENUMTYPENAME_CONVERSION(EValidEditControlFlag);
DECLARE_ENUMTYPENAME_CONVERSION(ETreeComboEditControlFlag);
DECLARE_ENUMTYPENAME_CONVERSION(EProgressControlFlag);
DECLARE_ENUMTYPENAME_CONVERSION(EDateTimeEditFlag);
...
*  @brief
*/
class COMMONCONTROLS_API CTreeListConfig
{
public:
