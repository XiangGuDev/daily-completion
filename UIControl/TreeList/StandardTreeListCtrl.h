...
namespace ControlUI
{
	...
	*  @brief	支持控件用
	*/
	class CONTROL_UI CStandardDataSource : public IListDataSource
	{
	public:
		/**
		*  @brief    构造函数
		...
		*  @brief    拷贝数据源
		*
		*  @param    CStandardDataSource* pStandardDataSource 目标数据源
		*  @return   
		*/
		virtual void CopyDataSource(CStandardDataSource* pStandardDataSource) {};
	...
	public:
		...
		*/
		virtual CStandardDataSource *InsertChild(size_t nIndex);
	...
	*  @brief	内含标准数据源
	*/
	class CONTROL_UI CStandardTreeListCtrl : public CTreeListCtrl
	{
	public:
	...
	public:
		...
		*  @param    size_t nColumn	列数
		*/
		EDITCONFIG GetCellConfig(size_t nRow, size_t nColumn);
		...
		*  @return   
		*/
		void SetStandardDataSource(CStandardDataSource *pStandardDataSource);
		...
		*  @return   
		*/
		CStandardDataSource* GetStandardDataSource();
